...
petrol_expenditures_oil_price<-petroleum_data %>% 
  ...
  scale_y_continuous(
    ...
    labels = percent_format(scale = 1),  # Format primary axis labels as percentages
    breaks = seq(0, 8, by = 1),
  ...
  theme(
    ...
    plot.title = element_text(size = 20, face = "bold",hjust = .5,color = "white"),  # Title text size
    plot.subtitle = element_text(size = 16,hjust=.5,color = "white",family="raleway"),
    axis.line = element_line(color = "#003554",size=1.5),
    axis.title = element_text(size = 14,color = "white",family="raleway"),  # Axis titles size
    axis.text = element_text(size = 14,color = "white",family="raleway"),  # Axis labels size
    ...
    plot.background = element_rect(fill = "black"),  # Plot background color
    legend.background = element_rect(fill = "black"),  # Legend background color
    panel.grid.major = element_line(color="lightgrey"),  # Major gridlines color
